...
public final class DoaMath {
	 ...
	 * undocumented behaviour and <em>might</em> give a wrong result. Use at your own risk!
	 *
	 ...
	 */
	public static float lerp(final float first, final float second, final double amt) {
		return (float) (first * (1 - amt) + second * amt);
	}
	 ...
	 * sourceRangeMax] is an undocumented behaviour and <em>might</em> give a wrong result. Use at your
	 * own risk!
	 *
	 ...
	 */
	public static float map(final int value, final int sourceRangeMin, final int sourceRangeMax, final int destinationRangeMin, final int destinationRangeMax) {
		return (float) (value - sourceRangeMin) / (sourceRangeMax - sourceRangeMin) * (destinationRangeMax - destinationRangeMin) + destinationRangeMin;
	}
